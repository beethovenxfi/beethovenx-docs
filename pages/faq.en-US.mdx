...
or, if the incentive is paid on [Hidden Hand](https://hiddenhand.finance/beets), you shall claim it there.
...
Once you know who you voted for, you can check [Beets Wars](https://www.beetswars.live/) to see what the bribe is to be paid in and approximately how much to expect.

If you want to know if your voting incentive was received, you can check your wallet by going to the site [Debank](https://debank.com/)
...
-   Again, check [Beets Wars](https://www.beetswars.live/) to see what your bribe is going to be paid in
...
5. After reading and following the above, if you have more questions ask in 🗳︲gauge-vote-chat
...
![ftm scan](/images/ftmscan_metamask.png)

**How do I bridge BEETS between Fantom and Optimism?**

You can use [stargate](https://stargate.finance/transfer) to bridge BEETS between Fantom and Optimism.
